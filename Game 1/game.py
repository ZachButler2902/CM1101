...
def normalise_input(user_input):
    ...
    'help'
    """
    modified_input = remove_punct(user_input)
    modified_input = remove_spaces(modified_input)
    return modified_input.lower()
...
def display_room(room):
    ...
    print()
    print(room["description"]) #Prints the room name and description from the imported rooms file.
    print()
...
def print_menu(exits):
    ...
    print("You can:")
    for choice in exits:
        print_menu_line(choice, exits[choice])
...
def menu(exits):
    ...
    while True:
        print_menu(exits) #prints the list of exits avaiable and waits for a valid choice
